...
// Expor funções globais
window.sendWhatsApp = sendWhatsApp;
>>>>>>> 5c2f95d787312796178c2d5ff0f43b6c9dd1ddef
window.openMaps = openMaps;const firebaseConfig = {
  apiKey: "AIzaSyDO7ZVtrHv9pBZ4VK18amIEW4v9xrXCVCY",
  authDomain: "agenda-montador.firebaseapp.com",
  projectId: "agenda-montador",
  storageBucket: "agenda-montador.firebasestorage.app",
...
function showTrialWarning(daysLeft) {
  ...
  if (daysLeft <= 0) {
    warningDiv.innerHTML = `
      ...
      <a href="#" onclick="window.open('https://pay.kiwify.com.br/SEU_LINK', '_blank'); return false;">
        Assinar agora por apenas R$ 29,90/mês
      </a>
    `;
  } else if (daysLeft === 1) {
    warningDiv.innerHTML = `
  ...
  const dashboard = document.getElementById('dashboardScreen');
  const welcomeBar = dashboard.querySelector('.welcome-bar');
  welcomeBar.insertAdjacentElement('afterend', warningDiv);
}
